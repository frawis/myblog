...
const Heading = ({
  ...
  switch (level) {
    ...
    case 'h5':
      return <h5 className={`text-base text-gray-800 font-${weight} leading-relaxed ${className}`}>{children}</h5>;
    case 'h6':
      return <h6 className={`text-base text-gray-800 font-${weight} leading-relaxed ${className}`}>{children}</h6>;
    default:
